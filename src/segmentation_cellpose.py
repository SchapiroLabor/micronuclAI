...
def get_args():
    ...
    optional.add_argument("-ft", "--flow-threshold", dest="flow_threshold",
                          action="store", required=False, default=0.4, type=float,
                          help="Flow threshold to be used for calculations. [default=0.4]")
    optional.add_argument("-bs", "--batch-size", dest="batch_size",
                          action="store", required=False, default=8, type=int,
